...
#define STATUS3_SEMI_INVULNERABLE       (STATUS3_UNDERGROUND | STATUS3_ON_AIR | STATUS3_UNDERWATER | STATUS3_SHADOW_FORCE)
...
#define STATUS3_7                       0x10000000
#define STATUS3_8                       0x20000000
#define STATUS3_9                       0x40000000
#define STATUS3_10                      0x80000000
...
#define SIDE_STATUS_FUTUREATTACK     (1 << 4)
#define SIDE_STATUS_MIST             (1 << 5)
#define SIDE_STATUS_SPIKES_DAMAGED   (1 << 6)
//4g
#define SIDE_STATUS_TAILWIND           (1 << 7)
#define SIDE_STATUS_LUCKY_CHANT        (1 << 8)
#define SIDE_STATUS_GRAVITY            (1 << 9)
#define SIDE_STATUS_TOXIC_SPIKES       (1 << 10)
#define SIDE_STATUS_TOXIC_SPIKES_DONE  (1 << 11)
#define SIDE_STATUS_STEALTH_ROCK       (1 << 12)
#define SIDE_STATUS_STEALTH_ROCK_DONE  (1 << 13)
...
#define MOVE_EFFECT_DEF_SPDEF_MINUS_1   0x38    //custom
