...
const u8 gUnknown_085E8B5B[] = _("Spotted POKéMON: |FD|Á!\nOwned POKéMON: |FD|Â!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see...\p");	
const u8 gUnknown_085E8BBA[] = _("SAVING...\nDON'T TURN OFF THE POWER.");	
const u8 gText_HOFCorrupted[] = _("Données du PANTHEON corrompues.");	
const u8 gText_HOFNumber[] = _("   PANTHEON N° ");	
...
const u8 gText_IDNumber[] = _("N°ID");	
...
const u8 gUnknown_085EB3FC[] = _("TYPE ET N° DU PKMN");	
...
const u8 gText_NumberF700[] = _("N° {SPECIAL_F7 0x00}");	
