const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_SPRITE(TURTWIG,         gMonPalette_Turtwig),
    SPECIES_SPRITE(GROTLE,          gMonPalette_Grotle),
    SPECIES_SPRITE(TORTERRA,        gMonPalette_Torterra),
    SPECIES_SPRITE(CHIMCHAR,        gMonPalette_Chimchar),
    SPECIES_SPRITE(MONFERNO,        gMonPalette_Monferno),
    SPECIES_SPRITE(INFERNAPE,       gMonPalette_Infernape),
    SPECIES_SPRITE(PIPLUP,          gMonPalette_Piplup),
    SPECIES_SPRITE(PRINPLUP,        gMonPalette_Prinplup),
    SPECIES_SPRITE(EMPOLEON,        gMonPalette_Empoleon),
    SPECIES_SPRITE(STARLY,          gMonPalette_Starly),
    SPECIES_SPRITE(STARAVIA,        gMonPalette_Staravia),
    SPECIES_SPRITE(STARAPTOR,       gMonPalette_Staraptor),
    SPECIES_SPRITE(BIDOOF,          gMonPalette_Bidoof),
    SPECIES_SPRITE(BIBAREL,         gMonPalette_Bibarel),
    SPECIES_SPRITE(KRICKETOT,       gMonPalette_Kricketot),
    SPECIES_SPRITE(KRICKETUNE,      gMonPalette_Kricketune),
    SPECIES_SPRITE(SHINX,           gMonPalette_Shinx),
    SPECIES_SPRITE(LUXIO,           gMonPalette_Luxio),
    SPECIES_SPRITE(LUXRAY,          gMonPalette_Luxray),
    SPECIES_SPRITE(BUDEW,           gMonPalette_Budew),
    SPECIES_SPRITE(ROSERADE,        gMonPalette_Roserade),
    SPECIES_SPRITE(CRANIDOS,        gMonPalette_Cranidos),
    SPECIES_SPRITE(RAMPARDOS,       gMonPalette_Rampardos),
    SPECIES_SPRITE(SHIELDON,        gMonPalette_Shieldon),
    SPECIES_SPRITE(BASTIODON,       gMonPalette_Bastiodon),
    SPECIES_SPRITE(BURMY,           gMonPalette_Burmy),
    SPECIES_SPRITE(WORMADAM,        gMonPalette_Wormadam),
    SPECIES_SPRITE(MOTHIM,          gMonPalette_Mothim),
    SPECIES_SPRITE(COMBEE,          gMonPalette_Combee),
    SPECIES_SPRITE(VESPIQUEN,       gMonPalette_Vespiquen),
    SPECIES_SPRITE(PACHIRISU,       gMonPalette_Pachirisu),
    SPECIES_SPRITE(BUIZEL,          gMonPalette_Buizel),
    SPECIES_SPRITE(FLOATZEL,        gMonPalette_Floatzel),
    SPECIES_SPRITE(CHERUBI,         gMonPalette_Cherubi),
    SPECIES_SPRITE(CHERRIM,         gMonPalette_Cherrim),
    SPECIES_SPRITE(SHELLOS,         gMonPalette_Shellos),
    SPECIES_SPRITE(GASTRODON,       gMonPalette_Gastrodon),
    SPECIES_SPRITE(AMBIPOM,         gMonPalette_Ambipom),
    SPECIES_SPRITE(DRIFLOON,        gMonPalette_Drifloon),
    SPECIES_SPRITE(DRIFBLIM,        gMonPalette_Drifblim),
    SPECIES_SPRITE(BUNEARY,         gMonPalette_Buneary),
    SPECIES_SPRITE(LOPUNNY,         gMonPalette_Lopunny),
    SPECIES_SPRITE(MISMAGIUS,       gMonPalette_Mismagius),
    SPECIES_SPRITE(HONCHKROW,       gMonPalette_Honchkrow),
    SPECIES_SPRITE(GLAMEOW,         gMonPalette_Glameow),
    SPECIES_SPRITE(PURUGLY,         gMonPalette_Purugly),
    SPECIES_SPRITE(CHINGLING,       gMonPalette_Chingling),
    SPECIES_SPRITE(STUNKY,          gMonPalette_Stunky),
    SPECIES_SPRITE(SKUNTANK,        gMonPalette_Skuntank),
    SPECIES_SPRITE(BRONZOR,         gMonPalette_Bronzor),
    SPECIES_SPRITE(BRONZONG,        gMonPalette_Bronzong),
    SPECIES_SPRITE(BONSLY,          gMonPalette_Bonsly),
    SPECIES_SPRITE(MIMEJR,          gMonPalette_MimeJr),
    SPECIES_SPRITE(HAPPINY,         gMonPalette_Happiny),
    SPECIES_SPRITE(CHATOT,          gMonPalette_Chatot),
    SPECIES_SPRITE(SPIRITOMB,       gMonPalette_Spiritomb),
    SPECIES_SPRITE(GIBLE,           gMonPalette_Gible),
    SPECIES_SPRITE(GABITE,          gMonPalette_Gabite),
    SPECIES_SPRITE(GARCHOMP,        gMonPalette_Garchomp),
    SPECIES_SPRITE(MUNCHLAX,        gMonPalette_Munchlax),
    SPECIES_SPRITE(RIOLU,           gMonPalette_Riolu),
    SPECIES_SPRITE(LUCARIO,         gMonPalette_Lucario),
    SPECIES_SPRITE(HIPPOPOTAS,      gMonPalette_Hippopotas),
    SPECIES_SPRITE(HIPPOWDON,       gMonPalette_Hippowdon),
    SPECIES_SPRITE(SKORUPI,         gMonPalette_Skorupi),
    SPECIES_SPRITE(DRAPION,         gMonPalette_Drapion),
    SPECIES_SPRITE(CROAGUNK,        gMonPalette_Croagunk),
    SPECIES_SPRITE(TOXICROAK,       gMonPalette_Toxicroak),
    SPECIES_SPRITE(CARNIVINE,       gMonPalette_Carnivine),
    SPECIES_SPRITE(FINNEON,         gMonPalette_Finneon),
    SPECIES_SPRITE(LUMINEON,        gMonPalette_Lumineon),
    SPECIES_SPRITE(MANTYKE,         gMonPalette_Mantyke),
    SPECIES_SPRITE(SNOVER,          gMonPalette_Snover),
    SPECIES_SPRITE(ABOMASNOW,       gMonPalette_Abomasnow),
    SPECIES_SPRITE(WEAVILE,         gMonPalette_Weavile),
    SPECIES_SPRITE(MAGNEZONE,       gMonPalette_Magnezone),
    SPECIES_SPRITE(LICKILICKY,      gMonPalette_Lickilicky),
    SPECIES_SPRITE(RHYPERIOR,       gMonPalette_Rhyperior),
    SPECIES_SPRITE(TANGROWTH,       gMonPalette_Tangrowth),
    SPECIES_SPRITE(ELECTIVIRE,      gMonPalette_Electivire),
    SPECIES_SPRITE(MAGMORTAR,       gMonPalette_Magmortar),
    SPECIES_SPRITE(TOGEKISS,        gMonPalette_Togekiss),
    SPECIES_SPRITE(YANMEGA,         gMonPalette_Yanmega),
    SPECIES_SPRITE(LEAFEON,         gMonPalette_Leafeon),
    SPECIES_SPRITE(GLACEON,         gMonPalette_Glaceon),
    SPECIES_SPRITE(GLISCOR,         gMonPalette_Gliscor),
    SPECIES_SPRITE(MAMOSWINE,       gMonPalette_Mamoswine),
    SPECIES_SPRITE(PORYGONZ,        gMonPalette_PorygonZ),
    SPECIES_SPRITE(GALLADE,         gMonPalette_Gallade),
    SPECIES_SPRITE(PROBOPASS,       gMonPalette_Probopass),
    SPECIES_SPRITE(DUSKNOIR,        gMonPalette_Dusknoir),
    SPECIES_SPRITE(FROSLASS,        gMonPalette_Froslass),
    SPECIES_SPRITE(ROTOM,           gMonPalette_Rotom),
    SPECIES_SPRITE(UXIE,            gMonPalette_Uxie),
    SPECIES_SPRITE(MESPRIT,         gMonPalette_Mesprit),
    SPECIES_SPRITE(AZELF,           gMonPalette_Azelf),
    SPECIES_SPRITE(DIALGA,          gMonPalette_Dialga),
    SPECIES_SPRITE(PALKIA,          gMonPalette_Palkia),
    SPECIES_SPRITE(HEATRAN,         gMonPalette_Heatran),
    SPECIES_SPRITE(REGIGIGAS,       gMonPalette_Regigigas),
    SPECIES_SPRITE(GIRATINA,        gMonPalette_Giratina),
    SPECIES_SPRITE(CRESSELIA,       gMonPalette_Cresselia),
    SPECIES_SPRITE(PHIONE,          gMonPalette_Phione),
    SPECIES_SPRITE(MANAPHY,         gMonPalette_Manaphy),
    SPECIES_SPRITE(DARKRAI,         gMonPalette_Darkrai),
    SPECIES_SPRITE(SHAYMIN,         gMonPalette_Shaymin),
    SPECIES_SPRITE(ARCEUS,          gMonPalette_Arceus),
