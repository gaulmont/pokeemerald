...
// Gen III
    ...
    SPECIES_SPRITE(TORTERRA,        gMonStillFrontPic_Torterra),
    SPECIES_SPRITE(CHIMCHAR,        gMonStillFrontPic_Chimchar),
    SPECIES_SPRITE(MONFERNO,        gMonStillFrontPic_Monferno),
    SPECIES_SPRITE(INFERNAPE,       gMonStillFrontPic_Infernape),
    ...
    SPECIES_SPRITE(STARLY,          gMonStillFrontPic_Starly),
    SPECIES_SPRITE(STARAVIA,        gMonStillFrontPic_Staravia),
    ...
    SPECIES_SPRITE(KRICKETOT,       gMonStillFrontPic_Kricketot),
    SPECIES_SPRITE(KRICKETUNE,      gMonStillFrontPic_Kricketune),
    ...
    SPECIES_SPRITE(CRANIDOS,        gMonStillFrontPic_Cranidos),
    SPECIES_SPRITE(RAMPARDOS,       gMonStillFrontPic_Rampardos),
    SPECIES_SPRITE(SHIELDON,        gMonStillFrontPic_Shieldon),
    SPECIES_SPRITE(BASTIODON,       gMonStillFrontPic_Bastiodon),
    SPECIES_SPRITE(BURMY,           gMonStillFrontPic_Burmy),
    SPECIES_SPRITE(WORMADAM,        gMonStillFrontPic_Wormadam),
    SPECIES_SPRITE(MOTHIM,          gMonStillFrontPic_Mothim),
    SPECIES_SPRITE(COMBEE,          gMonStillFrontPic_Combee),
    SPECIES_SPRITE(VESPIQUEN,       gMonStillFrontPic_Vespiquen),
    ...
    SPECIES_SPRITE(CHERUBI,         gMonStillFrontPic_Cherubi),
    SPECIES_SPRITE(CHERRIM,         gMonStillFrontPic_Cherrim),
    SPECIES_SPRITE(SHELLOS,         gMonStillFrontPic_Shellos),
    SPECIES_SPRITE(GASTRODON,       gMonStillFrontPic_Gastrodon),
    SPECIES_SPRITE(AMBIPOM,         gMonStillFrontPic_Ambipom),
    SPECIES_SPRITE(DRIFLOON,        gMonStillFrontPic_Drifloon),
    SPECIES_SPRITE(DRIFBLIM,        gMonStillFrontPic_Drifblim),
    SPECIES_SPRITE(BUNEARY,         gMonStillFrontPic_Buneary),
    SPECIES_SPRITE(LOPUNNY,         gMonStillFrontPic_Lopunny),
    SPECIES_SPRITE(MISMAGIUS,       gMonStillFrontPic_Mismagius),
    SPECIES_SPRITE(HONCHKROW,       gMonStillFrontPic_Honchkrow),
    SPECIES_SPRITE(GLAMEOW,         gMonStillFrontPic_Glameow),
    SPECIES_SPRITE(PURUGLY,         gMonStillFrontPic_Purugly),
    SPECIES_SPRITE(CHINGLING,       gMonStillFrontPic_Chingling),
    SPECIES_SPRITE(STUNKY,          gMonStillFrontPic_Stunky),
    ...
    SPECIES_SPRITE(MIMEJR,          gMonStillFrontPic_MimeJr),
    SPECIES_SPRITE(HAPPINY,         gMonStillFrontPic_Happiny),
    SPECIES_SPRITE(CHATOT,          gMonStillFrontPic_Chatot),
    SPECIES_SPRITE(SPIRITOMB,       gMonStillFrontPic_Spiritomb),
    ...
    SPECIES_SPRITE(CARNIVINE,       gMonStillFrontPic_Carnivine),
    SPECIES_SPRITE(FINNEON,         gMonStillFrontPic_Finneon),
    SPECIES_SPRITE(LUMINEON,        gMonStillFrontPic_Lumineon),
    SPECIES_SPRITE(MANTYKE,         gMonStillFrontPic_Mantyke),
    ...
    SPECIES_SPRITE(REGIGIGAS,       gMonStillFrontPic_Regigigas),
    SPECIES_SPRITE(GIRATINA,        gMonStillFrontPic_Giratina),
    SPECIES_SPRITE(CRESSELIA,       gMonStillFrontPic_Cresselia),
    SPECIES_SPRITE(PHIONE,          gMonStillFrontPic_Phione),
    SPECIES_SPRITE(MANAPHY,         gMonStillFrontPic_Manaphy),
