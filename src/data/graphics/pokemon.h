...
const u8 gMonIcon_Trutwig[] = INCBIN_U8("graphics/pokemon/turtwig/icon.4bpp");
...
const u32 gMonStillFrontPic_Cherrim[] = INCBIN_U32("graphics/pokemon/cherrim/front.4bpp.lz");
...
const u32 gMonStillFrontPic_MimeJr[] = INCBIN_U32("graphics/pokemon/mimejr/front.4bpp.lz");
